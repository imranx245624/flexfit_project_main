...
const OVERRIDE_QUERIES = {
  ...
  "pike-push-ups": ["pike push up exercise", "pike pushups", "shoulder push up"],
  "arm-circles": ["arm circles exercise", "shoulder rotation exercise", "shoulder circles exercise"],
  "wall-handstand-hold": ["wall handstand hold", "handstand against wall", "wall handstand"],
